...
from app.ingestion.models import TabularRowContent
...
class TabularLoader:
    ...
    def load(self, file_path: Path) -> list[TabularRowContent]:
    ...
    def _load_csv(self, file_path: Path) -> list[TabularRowContent]:
        rows: list[TabularRowContent] = []
    ...
    def _load_xlsx(self, file_path: Path) -> list[TabularRowContent]:
        rows: list[TabularRowContent] = []
